...
- `canvas:onMouseUp(x,y,b)` does not work on LuaRT 2.0.1 x64,don't know why. You can use `User32.dll` via `C` module of LuaRT to access user inputs. See the example at [docs/C.md](https://github.com/zeykatecool/betterUI/blob/main/docs/C.md).
